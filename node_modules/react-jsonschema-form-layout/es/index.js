      ...
      return _react2.default.createElement(
        ...
        layout.map(function (row, index) {
          return _react2.default.createElement(
            ...
            Object.keys(row).map(function (name, index) {
              var _row$name = row[name],
                  doShow = _row$name.doShow,
                  rowProps = _objectWithoutProperties(_row$name, ['doShow']);

              var style = {};
              if (doShow && !doShow({ formData: formData })) {
                style = { display: 'none' };
              }
              if (schema.properties[name]) {
                return _react2.default.createElement(
                  _reactBootstrap.Col,
                  _extends({}, rowProps, { key: index, style: style }),
                ...
                var _row$name2 = row[name],
                    ...
                    _rowProps = _objectWithoutProperties(_row$name2, ['render']);
                ...
                return _react2.default.createElement(
                  _reactBootstrap.Col,
                  _extends({}, _rowProps, { key: index, style: style }),
